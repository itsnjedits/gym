document.addEventListener('DOMContentLoaded', () => {
    ...
    function trimAndDecodeURL(url) {
        const baseURL = 'https://itsnjedits.github.io/gym/';
    ...
    title.addEventListener('click', () => {
        ...
        document.querySelector('.without-ads').innerHTML = `No ads ❌ only Gym vibes! 🔥✅`
    })

    playlistButton.addEventListener('click', () => {
        document.querySelector('.without-ads').innerHTML = `Instant Gym Playlist 💪`
